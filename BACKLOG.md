...
## 37. The catalog becomes the face: retire legacy starters, real-screenshot picker, template names — `in review` (built 2026-08-11 on `worktree-spec-37-catalog-face`, branched from integration/specs-14r-19; not merged, not pushed.
